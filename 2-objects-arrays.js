...
// }
//
// for (let p in engineers) {
//     console.log(`Заработная плата ${p} составляет ${engineers[p]} рублей.`)
// }
...
// let sumEven = 0; // Сумма четных элементов
// let max = numbers[0]; // Максимальное число
// let maxIndex = 0;
//
// for (let i = 0; i <= numbers.length; i++) {
//     console.log(`Индексу ${i} соответствует число ${numbers[i]}`);
//    
//     sum6 += numbers[i]; // Сумма элементов
//    
//     if (numbers[i] % 2 === 0) { // Сумма четных элементов
//         sumEven6 += numbers[i];
//     }
//    
//     if (numbers[i] > max6) { // Максимальное число
//         max6 = numbers[i];
//         maxIndex6 = i;
//     }
// }
...
// // N-7
// // Задание 7
// // Определить массив let arr = [5, 4, 3, -3, -mini-apps, -1, 8, -20, 0]
...
//
// let arr = [5, 4, 3, -3, -mini-apps, -1, 8, -20, 0];
//
// let newArr = [];
//
...
//     newArr.push({word: v, length: v.length});
// }
//
// console.log(newArr);